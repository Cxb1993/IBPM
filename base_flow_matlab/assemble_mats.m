...
%--specify matrices for ease in ensuing code
    ...
    if parms.deform == 'T'
        M_fl = mats.M_flag; Q_fl = mats.Q_flag;
        W_fl = mats.W_flag; Itil_fl = mats.Itilde_flag; 
        K_fl = mats.K_flag; J_Ef = mats.J_Ef; 
        J_Wf = mats.J_Wf; J_Es = mats.J_Es;
    end
...
if parms.deform == 'T'
    ...
    %--(1,2) block
        ...
        mats.Dr = mats.Dr + sparse( i, j + ngam , s , ndof, ndof );
    %--
    ...
    %--(2,1) block
        ...
        mats.Dr = mats.Dr + sparse( i + ngam , j , s , ndof, ndof );
    %--
