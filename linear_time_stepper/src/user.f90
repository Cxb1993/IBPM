...
CONTAINS
 ...
 !*****************************************************************!
  ...
  FUNCTION motion_grid( it )
    ...
    ! default is no flow
    motion_grid(1) = 0.D0   ! x-component of velocity in the body-fixed frame
...
!    xc = 0.5D0 + 10.D0*delta ! center of the bodyforce
!
!    IF (it > 14999 .And. it < 15010) then
!
!        IF ( ( (x-xc)**2.d0+y**2.d0 ) .le. (10.D0*delta)**2.d0 ) THEN
!                bodyforcey = 0.01
!        end if
!    end IF
